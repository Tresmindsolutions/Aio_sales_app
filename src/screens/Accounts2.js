                ...
                <View>
                    <TouchableOpacity>
                        ...
                        <View>
                            ...
                            <Text style={{fontSize:11, color:"#707070"}}>283 Homestead Rd, 24588 Rustburg</Text>
                        </View>
                        <View>
                            <Text style={{color:"#148BFF"}}>
                                -$51,845
                            </Text>
                        </View>
                        </View>
                    ...
                    style={[this.state.coloR ? {backgroundColor:"#e7f3ff"}:{backgroundColor:"#fff"}]}>
                        <View style={{borderBottomWidth:1, borderBottomColor:"#dce0e3", marginHorizontal:20, paddingVertical:5, flexDirection:"row", justifyContent:"space-between", alignItems:"center"}}>
                        <View>
                            <Text style={styles.itemUserName}>Ashanti Fashion</Text>
                            <Text style={{fontSize:11, color:"#707070"}}>283 Homestead Rd, 24588 Rustburg</Text>
                        </View>
                        ...
                        <View style={styles.stylishBox}>
                            ...
                            <View style={styles.whiteBox}>
                                <View style={{alignItems:"center", flex:.1}}>
                                    <Text style={{color:"#3D3D3D", color:"#3D3D3D"}}>Abrix Woonaccessoires BV</Text>
                                </View>
                                <View style={styles.detailsBox}>
                                    ...
                                    <View style={{flexDirection:"row", width:120}}>
                                        ...
                                        <Text style={styles.location}>Helper Brink 54, 9722 EN Groningen NL</Text>
                                    </View>
                                    </View>
                                ...
                                <View style={styles.webBox}>
                                    <View style={{flexDirection:"row"}}> 
                                        <MaterialCommunityIcons name="web" color="#000" size={10} />
                                        <Text style={styles.webSite}>Not Available</Text>
                                    </View>
                                    <View style={styles.accountDetailsBox}>
                                        <Text style={{fontSize:10, color:"#fff"}}>Account details</Text>
                                    </View>
                                    </View>
                            </View>
                        </View>
                        <View style={{alignItems:"center", paddingVertical:10}}>
                            <Text style={{color:"#148BFF", fontSize:15}}>Account location</Text>
                        </View>
