...
export default class ReceivePayment3 extends Component{
    constructor(){
        super();
        this.state={
            openbalance:[
    ...
    render(){
      ...
      //     navigation={this.props.navigation}
        />
                <View style={{width:"90%", alignSelf:"center"}}>
                    ...
                    <TouchableOpacity style={
                        ...
                        >
                            ...
                            {value.checked ? 
                            <Ionicons name="md-checkbox" size={26} color ={FontColor.blue} /> 
                            : 
                            <Ionicons name="md-square" size={24} color={theme.grayLight} />
                            }
                            </View>
                        </TouchableOpacity>
                ...
                <View style={style.horizantalLine}>

                </View>
                    </View>                        
                        )}
                        <View style={{flexDirection:"row", paddingTop:10}}>
                            <View style={{flex:.06}}></View>
