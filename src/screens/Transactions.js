                ...
                <View style={{width:"90%", alignSelf:"center"}}>
                    ...
                    <View style={style.TransactionBox}>
                        <View style={style.TransactionBoxFirstRow}>
                            <Text style={style.TransactionsType}>Abrix Woonaccessoires BV</Text>
                            <Text style={style.recieved}>Recieved</Text>
                        </View>
                        <View style={style.TransactionBoxSecondRow}>
                            <Text style={style.TransactionsTypeDetails}>Helper Brink 54, 9722 EN Groningen NL</Text>
                            <Text style={style.priceGreenColor}>+$51,845</Text>
                        </View>
                    </View>
                    <View style={style.TransactionBox}>
                        <View style={style.TransactionBoxFirstRow}>
                            <Text style={style.TransactionsType}>Alexander Men's Wear</Text>
                            <Text style={style.recieved}>Recieved</Text>
                        </View>
                        <View style={style.TransactionBoxSecondRow}>
                            <Text style={style.TransactionsTypeDetails}>Berchvill 14, 1046 CA Tapie</Text>
