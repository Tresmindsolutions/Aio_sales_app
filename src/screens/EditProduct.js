        ...
        <Content style={styles.content}>
          ...
          <View>
            <View style={styles.CardView}>
              ...
              <View>
                <Text style={styles.textStyle}>Case Count</Text>
                <TextInput
                  style={styles.viewInput}
                ...
                <View style={styles.pickerStyles}>
                  <RNPickerSelect
                    ...
                    items={[
                      ...
                      {
                        label: "Easypaisa Burger deal",
                        value: "Easypaisa Burger deal"
                      }
                    ]}
                    Icon={() => {
                      return (
              ...
              <View>
                <Text style={styles.textStyle}>SRP</Text>
                <TextInput
                  style={styles.viewInput}
              ...
              <View style={{ alignContent: "space-between" }}>
                <Text style={styles.textStyle}>Unit UPC</Text>
              ...
              <View style={{ alignContent: "space-between" }}>
                <Text style={styles.textStyle}>Case UPC</Text>
                <View style={styles.viewInputIcon}>
                  <TextInput
                    style={{ fontSize: 12, width: "85%" }}
